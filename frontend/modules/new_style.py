...
class StyleSheetGenerator:
    ...
    def generate_table_style(self) -> str:
        """Generate style for table widgets"""
        return f"""
            QTableWidget {{
                background-color: {self.colors.surface};
                border: 1px solid {self.colors.grey_300};
                border-radius: {self.borderRadius.md};
                gridline-color: {self.colors.grey_200};
                font-size: {self.typography.caption};
            }}
            QTableWidget::item {{
                padding: {self.spacing.sm};
                border-bottom: 1px solid {self.colors.grey_200};
            }}
            ...
            QHeaderView::section {{
                ...
                padding: {self.spacing.sm};
                border: none;
                border-right: 1px solid {self.colors.grey_300};
                border-bottom: 1px solid {self.colors.grey_300};
                font-weight: {self.typography.medium};
            }}
        """
    
    def generate_list_widget_style(self) -> str:
        """Generate style for list widgets"""
        return f"""
            QListWidget {{
                background-color: {self.colors.surface};
                border: 1px solid {self.colors.grey_300};
    ...
    def generate_combo_box_style(self) -> str:
        """Generate style for combo boxes"""
        return f"""
            QComboBox {{
                background-color: {self.colors.surface};
                border: 1px solid {self.colors.grey_300};
            ...
            QComboBox::down-arrow {{
                ...
                border-top: 5px solid {self.colors.grey_600};
                width: 0px;
                height: 0px;
            }}
