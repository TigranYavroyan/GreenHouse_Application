...
MAIN_WINDOW_TEXT_MAP: Dict[str, SetEntry] = {
    ...
    "scheduleDelayCheck": ("text", Schedule.DELAY),
    "scheduleFixedTimeCheck": ("text", Schedule.RUN_AT_FIXED),
    ...
    "logicLoadButton": ("text", Logic.GET_CONFIG),
    "logicValidateButton": ("text", Logic.GENERATE_JSON),
